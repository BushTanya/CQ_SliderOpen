...
export default class SliderGridQuestionView extends QuestionWithAnswersView {
     ...
     */
    constructor(question, settings, sliderSettings, isCustomScaleOn = false, ifSetQuestionVal) {
    ...
    render() {
		...
		var sliderDirection = this.question.isRtl ? 'cf-slider--horizontal-rtl' : 'cf-slider--horizontal';
		...
		var isRtl = this.question.isRtl ? 'cf-slider-grid-answer--rtl' : '';
    ...
    hideErrors() {
        ...
        var textboxNode = this.container.querySelector('.cf-text-box');
		if (textboxNode != null) {
